...
var DEFAULT_HISTORIES_PATH = ".obsidian/plugins//histories.json";
    ...
    for (const path of this.paths) {
      try {
        ...
        new import_obsidian2.Notice(
          `\u26A0 Fail to load ${path} -- Autocomplete Plugin -- 
 ${e}`,
          0
        );
      }
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        new import_obsidian9.Notice("Copy settings of Autocomplete Plugin");
      }
    });
  }
  async loadSettings() {
